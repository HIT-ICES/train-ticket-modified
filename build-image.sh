...
echo 'tag the image'
docker images | grep nocirclesmell | awk '{print "docker tag"" "$1":"$2 " ""172.31.43.94:5000/"$1":"$2}'| sh

echo 'docker push to the registry'
docker images | grep 172.31.43.94:5000/nocirclesmell | awk '{print "docker push"" "$1":"$2}' | sh
